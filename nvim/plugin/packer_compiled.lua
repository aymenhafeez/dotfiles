...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "nvim-autopairs", "ultisnips", "cmp-buffer", "cmp-cmdline", "cmp-nvim-lsp", "cmp-nvim-lsp-signature-help", "cmp-nvim-ultisnips", "cmp-path" },
  ...
  ["nvim-lspconfig"] = {
    after = { "fidget.nvim", "nvim-cmp", "nvim-navic" },
...
vim.cmd [[au FileType markdown ++once lua require("packer.load")({'nvim-markdown'}, { ft = "markdown" }, _G.packer_plugins)]]
...
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'neoscroll.nvim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lsp-installer', 'nvim-treesitter', 'gitsigns.nvim', 'nvim-notify'}, { event = "BufRead *" }, _G.packer_plugins)]]
