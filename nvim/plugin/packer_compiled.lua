...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "ultisnips", "cmp-buffer", "cmp-nvim-lsp", "cmp-path", "cmp-cmdline", "cmp-nvim-ultisnips", "cmp-nvim-lsp-signature-help" },
  ...
  ["nvim-lspconfig"] = {
    after = { "nvim-navic", "nvim-cmp", "fidget.nvim" },
...
vim.cmd [[au UIEnter * ++once lua require("packer.load")({'bufferline.nvim', 'lualine.nvim'}, { event = "UIEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-treesitter', 'nvim-lsp-installer', 'nvim-notify', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
