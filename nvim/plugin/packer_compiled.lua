...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-buffer", "ultisnips", "cmp-nvim-lsp", "cmp-nvim-ultisnips", "cmp-nvim-lsp-signature-help", "cmp-path", "cmp-cmdline" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-lsp-installer', 'nvim-notify', 'gitsigns.nvim', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
