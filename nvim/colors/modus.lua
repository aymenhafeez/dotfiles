...
local function apply()
  ...
  c.linenr_bg = key == "dark" and c.bg_dim or c.linenr_bg
  ...
  set_highlights({
    ...
    TabLine                          = { fg = c.border, bg = c.bg_tab_bar, underline = true, sp = mod(c.bg_status_line_active, -20) },
    TabLineSel                       = { fg = c.fg_main, bg = c.bg_status_line_active, bold = true, underline = true, sp = c.bg_status_line_active },
    TabLineFill                      = { fg = c.border, bg = c.bg_tab_bar, underline = true, sp = mod(c.bg_status_line_active, -20) },
    ...
    WinSeparator                     = { fg = c.bg_active, bold = true },
    ...
    TreesitterContextLineNumber      = { bg = c.bg_main, fg = c.fg_dim },
    ...
    -- GitSigns
    GitSignsAdd                      = { fg = c.fg_added_intense, bg = c.linenr_bg },
    GitSignsChange                   = { fg = c.fg_changed_intense, bg = c.linenr_bg },
    GitSignsDelete                   = { fg = c.fg_removed_intense, bg = c.linenr_bg },
    ...
    MiniTablineHidden                = { fg = c.border, bg = c.bg_tab_bar, underline = true, sp = mod(c.bg_status_line_active, -5) },
    ...
    MiniTablineTabpagesection        = { bg = c.bg_alt, fg = NONE, underline = true, sp = mod(c.bg_status_line_active, -10) },
