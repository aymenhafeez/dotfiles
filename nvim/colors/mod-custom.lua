...
local palettes = {
  light = {
    ...
    bg_completion = mod("#ffffff", -10),
    -- bg_paren_match = "#5fcfff",
    bg_paren_match = "#d6e3ef",
    ...
    bg_inactive = "#f6f7f9",
    fg_inactive = "#3c3f47",
    -- bg_status_line_active = mod("#e0e0e2", -10),
    bg_status_line_active = "#ebebed",
    fg_status_line_active = "#0a0a0a",
    bg_status_line_inactive = mod("#e6e9ef", -8),
    fg_status_line_inactive = "#4a4d57",
    bg_tab_bar = "#e6e9ef",
    bg_tab_current = "#f4f6fa",
    bg_tab_other = "#dce1ea",
    fg_tab_other = "#292c34",
    bg_tab_alternate = "#d7deea",
    bg_added = "#c1f2d1",
  ...
  dark = {
    ...
    bg_inactive = "#101010",
    fg_inactive = "#bfc0c4",
    bg_status_line_active = "#2a2a2a",
    fg_status_line_active = "#f0f0f0",
    bg_status_line_inactive = "#141414",
    fg_status_line_inactive = "#969696",
    bg_tab_bar = "#1b1b1b",
    bg_tab_current = "#000000",
    bg_tab_other = "#2a2a2a",
    fg_tab_other = "#f7f7f7",
    bg_tab_alternate = "#2a2a2a",
    bg_added = "#00381f",
...
local function apply()
  ...
  elseif variant == "dark" or variant == "tinted" then
  ...
  c.linenr_bg = key == "light" and c.bg_main or c.bg_dim
  c.git_add_bg = key == "light" and c.bg_added or "dark_tinted" and c.bg_added or c.bg_main
  c.git_change_bg = key == "light" and c.bg_changed or "dark_tinted" and c.bg_changed or c.bg_main
  c.git_delete_bg = key == "light" and c.bg_removed or "dark_tinted" and c.bg_dim or
      c.bg_main
  c.bool_fg = key == "dark_tinted" and c.yellow_faint or c.blue_warmer
  c.bg_sign = key == "dark_tinted" and c.bg_main or c.bg_dim
  ...
  vim.g.terminal_color_9 = c.yellow_intense
  ...
  set_highlights({
    ...
    TerminalNormal                   = { bg = mod(c.bg_main, 0) },
    NormalFloat                      = vim.o.winborder == "rounded" and { bg = bg_main } or { bg = c.bg_active },
    FloatBorder                      = vim.o.winborder == "none" and { fg = c.bg_active, bg = c.bg_active } or
        { fg = c.border, bg = bg_main },
    FloatTitle                       = { fg = c.border_highlight, bg = c.bg_hl_line },
    Folded                           = { fg = c.green_faint, bg = c.bg_hl_line },
    LineNr                           = { fg = c.fg_dim, bg = c.linenr_bg },
    ...
    FoldColumn                       = { fg = c.fg_inactive, bg = c.linenr_bg },
    ...
    Pmenu                            = vim.o.winborder == "rounded" and { bg = bg_main } or { bg = c.bg_completion },
    PmenuSel                         = { fg = c.fg_main, bg = c.bg_hl_line },
    PmenuMatch                       = { fg = c.fg_main, bold = true, underline = true },
    PmenuMatchSel                    = { fg = c.blue, bold = true, underline = true },
    PmenuSbar                        = { fg = c.fg_active, bg = c.bg_active },
    PmenuThumb                       = { bg = c.border },
    PmenuBorder                      = { link = "FloatBorder" },
    Menu                             = { link = "Pmenu" },
    Scrollbar                        = { fg = c.bg_status_line_active },
    ScrollbarThumb                   = { fg = c.border },
    Directory                        = { fg = c.blue },
    Title                            = { fg = c.fg_alt, bg = c.bg_main, bold = true },
    Visual                           = { bg = c.bg_hl_line },
    VisualNOS                        = { link = "Visual" },
    VisualNonText                    = { bg = c.bg_hl_line, fg = c.fg_dim },
    WildMenu                         = { fg = c.fg_main, bg = c.visual },
    Whitespace                       = { link = "NonText" },
    StatusLine                       = { fg = c.fg_status_line_active, bg = c.bg_status_line_active, underline = false, sp = mod(c.bg_status_line_active, -10) },
    StatusLineNC                     = { fg = c.fg_status_line_inactive, bg = c.bg_status_line_active, underline = false, sp = mod(c.bg_status_line_inactive, -10) },
    -- StatusLine                       = { fg = c.fg_status_line_active, bg = c.bg_main, underline = false, sp = mod(c.bg_status_line_active, -10) },
    -- StatusLineNC                     = { fg = c.fg_status_line_inactive, bg = c.bg_main, underline = false, sp = mod(c.bg_status_line_inactive, -10) },
    -- StatusLine                       = { fg = c.comment, bg = c.bg_status_line_active, underline = true, overline = true },
    -- StatusLineNC                     = { fg = c.comment, bg = c.bg_status_line_inactive, underline = true, overline = true },
    -- StatusLineTerm                   = { fg = c.fg_status_line_active, bg = c.bg_status_line_active, underline = false, sp = mod(c.bg_main, 0) },
    -- StatusLineTermNC                 = { fg = c.fg_status_line_inactive, bg = c.bg_status_line_inactive, underline = false, sp = mod(c.bg_status_line_inactive, -10) },
    TabLine                          = { fg = c.border, bg = c.bg_main, underline = false, sp = mod(c.bg_tab_bar, -5) },
    TabLineSel                       = { fg = c.fg_main, bg = c.bg_main, bold = true, underline = false, sp = mod(c.bg_tab_bar, -5) },
    TabLineFill                      = { fg = c.border, bg = c.bg_main, underline = false, sp = mod(c.bg_tab_bar, -5) },
    ...
    WinSeparator                     = is_light and { fg = "#e0e0e0" } or
        { fg = mod(c.fg_dim, -50), bold = true },
    ...
    -- User1                            = { fg = c.red_faint, bold = true },
    -- User2                            = { fg = c.fg_main },
    -- User3                            = { fg = c.fg_active, bold = true },
    -- User5                            = { fg = c.blue_intense },
    -- User6                            = { fg = c.blue_faint, bg = c.bg_status_line_active },
    -- User7                            = { fg = c.fg_main, bold = true },
    -- -- User8                            = { fg = c.blue, bg = c.bg_status_line_active },
    -- User9                            = { fg = c.blue_intense },

    -- Syntax
    Comment                          = { fg = c.comment, italic = true },
    -- String                           = { fg = c.string_fg },
    String                           = { fg = c.blue_warmer },
    ...
    Label                            = { fg = c.cyan },
    Keyword                          = { fg = c.magenta_cooler },
    Exception                        = { fg = c.magenta_cooler },
    StorageClass                     = { fg = c.magenta_cooler },
    Structure                        = { fg = c.magenta_cooler },
    Constant                         = { fg = c.rust },
    -- Function                         = is_light and { fg = c.func_bg, bold = true } or { fg = c.func_bg, bold = false },
    Function                         = { fg = c.magenta, bold = false },
    ...
    Todo                             = is_light and { fg = c.fg_main, bg = c.bg_yellow_intense, bold = true } or
        { fg = c.bg_main, bg = c.yellow, bold = true },
    Type                             = { fg = c.magenta_cooler },
    ...
    Special                          = is_light and { fg = c.magenta_cooler, bold = false } or { fg = "NvimLightCyan" },
    -- Special                          = { fg = c.magenta_cooler, bold = false },
    ...
    LspReferenceText                 = { bg = c.bg_hl_line, fg = c.fg_main },
    ...
    TreesitterContext                = { bg = bg_main, underline = true, sp = mod_custom(c.comment, 120) },
    TreesitterContextSeparator       = { fg = c.bg_status_line_active },
    TreesitterContextLineNumber      = { bg = c.linenr_bg, fg = c.fg_main, bold = true, underline = true, sp = mod_custom(c.comment, 120) },

    -- Treesitter
    ["@variable"]                    = {},
    ["@variable.builtin"]            = { fg = c.magenta_cooler },
    ["@variable.parameter"]          = is_light and { fg = c.cyan } or { fg = c.fg_main },
    ...
    ["@type"]                        = { fg = c.cyan_intense },
    ["@type.builtin"]                = { fg = c.cyan_intense },
    ["@type.builtin.c"]              = { fg = c.cyan },
    ...
    ["@function.builtin"]            = is_light and { fg = c.magenta } or { fg = "NvimLightCyan" },
    ...
    ["@keyword.function"]            = { fg = c.magenta_cooler },
    ["@keyword.operator"]            = { link = "@operator" },
    ["@keyword.import"]              = { link = "Include" },
    ["@keyword.import.c"]            = { fg = c.red_cooler, bold = true, italic = true },
    ["@keyword.type"]                = { fg = c.magenta_cooler },
    ...
    ["@comment.error"]               = { fg = c.bg_main, bg = c.red, bold = true },
    ["@comment.warning"]             = { fg = c.bg_main, bg = c.warning, bold = true },
    ["@comment.todo"]                = { link = "Todo" },
    ["@comment.note"]                = { fg = c.bg_main, bg = c.hint, bold = true },

    ["@markup.strong"]               = { bold = true },
    ["@markup.italic"]               = { italic = true },
    ["@markup.strikethrough"]        = { strikethrough = true },
    ["@markup.underline"]            = { underline = true },
    ["@markup.raw.markdown_inline"]  = { fg = c.blue_warmer, bg = c.bg_tab_bar, underline = true, sp = mod(c.bg_tab_bar, -5) },

    ["@markup.heading"]              = { link = "Title" },
    ["@markup.heading.1"]            = { fg = c.blue, bold = true },
    ["@markup.heading.2"]            = { fg = c.yellow, bold = true },
    ["@markup.heading.3"]            = { fg = c.green_faint, bold = true },
    ["@markup.heading.4"]            = { fg = c.cyan, bold = true },
    ["@markup.heading.5"]            = { fg = c.red, bold = true },
    ["@markup.heading.6"]            = { fg = c.cyan_warmer, bold = true },

    ["@markup.quote"]                = { fg = c.rust, italic = true },
    ...
    -- GitSigns
    GitSignsAdd                      = { fg = c.fg_added_intense },
    GitSignsChange                   = { fg = c.fg_changed_intense },
    GitSignsDelete                   = { fg = c.fg_removed_intense },

    -- Neogit
    NeogitActiveItem                 = { bg = c.bg_changed },
    NeogitCommitViewHeader           = { fg = c.fg_main, bg = c.bg_hl_line },
    ...
    SnacksPicker                     = { bg = c.bg_active },
    -- SnacksWinSeparator               = { fg = c.bg_active, bg = c.bg_active },
    SnacksPickerInputBorder          = { fg = c.fg_dim, bg = c.bg_active },
    SnacksPickerTree                 = { fg = mod_custom(c.comment, 100), bg = c.bg_active },
    SnacksPickerPrompt               = { fg = c.fg_dim, bg = c.bg_active },
    SnacksIndentScope                = { fg = mod_custom(c.comment, 60) },
    SnacksIndent                     = { fg = mod_custom(c.comment, 120) },
    ...
    MiniIconsAzure                   = { fg = c.blue_faint },

    MiniFilesNormal                  = { bg = bg_main },
    MiniFilesBorder                  = { fg = c.fg_active, bg = bg_main },
    ...
    BufferLineOffsetSeparator        = { link = "SnacksWinSeparator" },
    BufferLineFill                   = { bg = c.bg_dim },
    -- BufferLineOffsetHelp             = { fg = c.fg, bg = "#131417", underline = true, sp = c.comment },
    BufferLineOffset                 = { fg = c.fg_main, bg = c.bg_dim, bold = false },
    BufferLineOffsetExplorer         = { fg = c.fg_main, bg = c.bg_active, underline = false, sp = c.border },

    texEnvArgName                    = { fg = c.fg_main, bold = true }
  })
end
...
vim.api.nvim_create_autocmd("VimEnter", {
  once = true,
  callback = function()
    if vim.g.colors_name == "mod-custom" then
