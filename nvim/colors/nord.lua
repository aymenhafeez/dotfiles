...
local brightestblack = lighter(brighterblack)
...
local highlights = {
	...
	ModeMsg = { fg = mod(brightestblack, 40) },
	MoreMsg = { fg = cyan },
	...
	StatusLine = { fg = lighter(lighterblack), bg = black },
	StatusLineNC = { fg = brightestblack, bg = darker(lightblack) },
	StatusLineTerm = { fg = background, bg = green, bold = false },
	...
	TabLineFill = { fg = brighterblack, bg = black },
	...
	Conceal = { fg = mod(orange, 30), bold = false },
	...
	TreesitterContext = { bg = mod(black, -5) },
	TreesitterContextLineNumber = { bg = mod(black, -5) },

	BlinkCmpMenu = { fg = darkwhite, bg = background },
	BlinkCmpLabelMatch = { fg = foreground, bold = true },
