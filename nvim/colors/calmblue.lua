...
local hlgroups = {
  ...
  StatusLine = { fg = c.steel, bg = c.smoke_dark },
  StatusLineNC = { fg = c.steel, bg = c.ocean },
  Substitute = { link = "Search" },
  -- TabLine = { fg = c.steel, bg = c.jeans, italic = true },
  TabLine = { link = "Normal" },
  ...
  ["@keyword.function"] = { fg = c.cerulean, italic = true },
  ["@keyword.return"] = { fg = c.cerulean },
  ...
  ScrollbarHandle = { bg = c.orange },
  ScrollbarCursor = { bg = c.orange },
  ScrollbarCursorHandle = { bg = c.orange },
...
vim.keymap.set("n", "<leader>tc", function()
  if vim.g.calmblue_variant == "calmblue" then
    vim.g.calmblue_variant = "darkerblue"
    vim.notify("Switched to Darker Blue variant", vim.log.levels.INFO)
  else
    vim.g.calmblue_variant = "calmblue"
    vim.notify("Switched to Calm Blue variant", vim.log.levels.INFO)
  end
