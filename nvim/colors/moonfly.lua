...
g.moonflyCursorColor = g.moonflyCursorColor == nil and false or g.moonflyCursorColor
g.moonflyItalics = g.moonflyItalics == nil and true or g.moonflyItalics
g.moonflyNormalPmenu = g.moonflyNormalPmenu == nil and false or g.moonflyNormalPmenu
g.moonflyNormalFloat = g.moonflyNormalFloat == nil and false or g.moonflyNormalFloat
g.moonflyTerminalColors = g.moonflyTerminalColors == nil and true or g.moonflyTerminalColors
g.moonflyTransparent = g.moonflyTransparent == nil and false or g.moonflyTransparent
g.moonflyUndercurls = g.moonflyUndercurls == nil and true or g.moonflyUndercurls
g.moonflyUnderlineMatchParen = g.moonflyUnderlineMatchParen == nil and false or g.moonflyUnderlineMatchParen
g.moonflyVirtualTextColor = g.moonflyVirtualTextColor == nil and false or g.moonflyVirtualTextColor
g.moonflyWinSeparator = g.moonflyWinSeparator == nil and 1 or g.moonflyWinSeparator
