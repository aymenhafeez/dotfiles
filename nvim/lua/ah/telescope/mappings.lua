...
map("n", "<leader>sg", utils.live_grep, { noremap = true, silent = true, desc = "Search in current directory" })
...
map("n", "<leader>sb", utils.search_buffers, { noremap = true, silent = true, desc = "Open buffers" })
map("n", "<leader>sd", utils.search_diagnostics, { noremap = true, silent = true, desc = "Diagnostics" })
map("n", "<leader>sh", utils.search_help, { noremap = true, silent = true, desc = "Search help" })
map("n", "<leader>sn", utils.search_notes, { noremap = true, silent = true, desc = "Show notes" })
...
map("n", "<leader>/", utils.buffer_fuzzy_search, { noremap = true, silent = true, desc = "Search current buffer" })
